...
describe('apps - promotions - list', () => {
  ...
  test('fails - can only be used with api key', async () => {
    ...
    const response = async () =>
      userdocks.apps.promotions.list('408edd4e-ef97-49f6-8a02-7f325e897096');
  ...
  test('fails - appId is not a uuid', async () => {
    ...
    const response = async () => userdocks.apps.promotions.list('a');
  ...
  test('success', async () => {
    ...
    const response = await userdocks.apps.promotions.list(
