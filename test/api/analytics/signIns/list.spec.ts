...
describe('analytics - sign ins - list', () => {
  beforeEach(() => {
    // @ts-ignore
  ...
  test('fails - can only be used with api key', async () => {
    ...
    const response = async () =>
      userdocks.analytics.signIns.list('2022-12-12', '2022-12-14');
  ...
  test('fails - invalid from date', async () => {
    ...
    const response = async () => userdocks.analytics.signIns.list('1', '1');
  ...
  test('fails - invalid to date', async () => {
    ...
    const response = async () =>
      userdocks.analytics.signIns.list('2022-12-12', '1');
  ...
  test('success', async () => {
    ...
    const response = await userdocks.analytics.signIns.list(
      '2022-12-12',
      '2022-12-14',
    );
